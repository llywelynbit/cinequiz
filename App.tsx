...
@layer utilities {
  ...
  .border-amber-400\/50 {
    border-color: color-mix(in srgb, oklch(.828 .189 84.429) 50%, transparent);
  }
  ...
  .bg-amber-500\/30 {
    background-color: color-mix(in srgb, oklch(.769 .188 70.08) 30%, transparent);
  }
  ...
  .bg-purple-900\/95 {
    background-color: color-mix(in srgb, oklch(.381 .176 304.987) 95%, transparent);
  }

  @supports (color: color-mix(in lab, red, red)) {
    .bg-purple-900\/95 {
      background-color: color-mix(in oklab, var(--color-purple-900) 95%, transparent);
    }
  }
  ...
  .text-amber-400\/50 {
    color: color-mix(in srgb, oklch(.828 .189 84.429) 50%, transparent);
  }
  ...
  .text-purple-200\/50 {
    color: color-mix(in srgb, oklch(.902 .063 306.703) 50%, transparent);
  }

  @supports (color: color-mix(in lab, red, red)) {
    .text-purple-200\/50 {
      color: color-mix(in oklab, var(--color-purple-200) 50%, transparent);
    }
  }

  .text-purple-200\/70 {
    color: color-mix(in srgb, oklch(.902 .063 306.703) 70%, transparent);
  }
  ...
  @media (hover: hover) {
    .hover\:bg-amber-500\/40:hover {
      background-color: color-mix(in srgb, oklch(.769 .188 70.08) 40%, transparent);
    }
